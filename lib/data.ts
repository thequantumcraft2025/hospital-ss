...
export const departments = [
  ...
  },
  {
    ...
    fullDescription:
       "Our Joint Replacement department specializes in advanced knee and hip replacement procedures designed to relieve pain and restore mobility. From thorough pre-operative evaluation to surgery and structured post-operative rehabilitation, we ensure safe treatment and a comfortable recovery journey for every patient.",
    services: [
      "Spine Surgery",
      "Fracture Management",
      "Physiotherapy & Rehabilitation",
  ...
  },
  {
    ...
    name: "Neuro Care",
    icon: Siren,
    shortDescription: "Advanced neurological care with precise diagnosis and specialized treatment for brain and nerve conditions.",
    fullDescription:
      "Our Neuro Care department provides specialized evaluation and treatment for disorders of the brain, spine, and nervous system. Supported by experienced specialists and modern diagnostic facilities, we ensure accurate diagnosis, timely intervention, and comprehensive patient-centered care.",
    services: [
      "Neurological Consultation & Evaluation",
      "Stroke Diagnosis & Management",
      "Brain & Nerve Disorder Treatment",
      "Spine & Nervous System Care",
...
export const doctors = [
  ...
  },
  {
    id: "dr-Sandeep",
    name: "Dr. Sandeep",
    qualification: "M.B.B.S., Ms., M.ch Neuro ",
    specialty: "Neurological Consultation & Evaluation",
    department: "emergency",
    experience: "10 years",
    bio: "Dr. Sandeep A is a skilled Neuro Surgeon with 10 years of experience, specializing in advanced neuro surgical procedures and complex brain and spine conditions. His precise surgical expertise and patient-focused approach ensure safe and effective neurological care.",
    opDays: "Mon, Wed, Fri",
    opTime: "2:00 PM - 6:00 PM",
